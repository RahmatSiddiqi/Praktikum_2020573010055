...
<body class="antialiased">
    <div
        class="relative flex items-top justify-center min-h-screen bg-light-100 light:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        ...
        <div class="text-center ms-3">
            <h1 style="font-size: 5rem; text-decoration-line: underline;">WELCOME TO IMGSTOQ</h1>
        </div>
</body>
